...
function buyActionCard(){
    ...
    var request = $.ajax({ cache: false,
        ...
        data:{ action: 'buyActionCard',
            positionOnBoard: $('#actioncards_on_table li').indexOf(this)//TODO dylan index van 'li' moet door gegeven worden als ik + druk, gwn achter deze positionOnBoard zetten
        }
    });
    request.done(function (data) {
        alert(success(data));

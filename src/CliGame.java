...
public class CliGame {
    ...
    private void buyCard() {
        int remainingBuys = g.remainingActionsInPhase;
    ...
    private void playActionCard() {
        ...
        while (g.remainingActionsInPhase != 0) {
    ...
    private void useMine(int numberOfThePlayer) {
        ...
        Player activePlayer = g.getActivePlayer(numberOfThePlayer);
        treasureCardsInHand = scanArrayForSpecificCard(g.treasureCardTable.getCardOnPos(0), activePlayer.returnHand());
        int cost = 0;

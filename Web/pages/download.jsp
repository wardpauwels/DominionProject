...
<div id="container">
    <div class="header">
        ...
        <div class="play-button" title="Play">
            <a href="../assets/client" onclick="javascript: var that=this; ga('send', 'pageview', {'page': '../assets/client/wurmclient.jnlp', 'title': 'Play'}); setTimeout(function(){location.href=that.href;},300); ga('send', 'event', 'play', 'stable'); return false;"></a></div>

...
public class GameTest {
    ...
    public void checkRemaingActionsAtStart(){
        assertEquals("Amount of actions niet begonnen bij 0", 1, g.getAmountOfActionsRemaining());
    }
    @Test
    ...
    public void lowerAmountOfActionsTester() throws Exception {
        ...
        assertEquals("Amount of actions is niet omlaag gegeaan", 0, g.getAmountOfActionsRemaining());
    }
    @Test
    public void villageAtionCardTester(){
        g.useActionCard("Village", 0);
        assertEquals("Remaining actions niet omhoog", 3, g.getAmountOfActionsRemaining());
    ...
    public void woodcutterAtionCardTester(){
        ...
        assertEquals("Amount of remaining buys niet omhoog", 2, g.getAmountOfActionsRemaining());
    }
    @Test
    ...
    public void councilRoomAtionCardTester(){
        ...
        g.resetAmountOfActions();
        assertEquals("Geen buys bij gekregen", 2, g.getAmountOfActionsRemaining());
    }
    @Test
    public void festivalAtionCardTester(){
        g.useActionCard("Festival", 0);
        assertEquals("Geen extra acties gekregen", 3, g.getAmountOfActionsRemaining());
        assertEquals("Geen extra coins gekregen", 2, g.getAmountOfCoinsOfPlayer());
        g.resetAmountOfActions();
        assertEquals("Geen extra buys gekregen", 2, g.getAmountOfActionsRemaining());
    }
    @Test
    public void labratoryAtionCardTester(){
        ...
        assertEquals("Geen extra acties gekregen", 2, g.getAmountOfActionsRemaining());
    }
    @Test

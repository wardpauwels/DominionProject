...
public class DeckTest {
    ...
    public void generateStarterDeck() throws Exception {
        assertEquals("Deck niet gevuld", 5, d.getSize());
    }

    @Test
    public void addCardToDeck() throws Exception {
        d.addCardToDeck(g.getCardFromPosInActionTable(0));
        assertEquals("Geen kaart toegevoegd", 6, d.getSize());
    }

    @Test
    public void addCardToSpecificPositionInDeck() throws Exception {
        d.addCardToSpecificPositionInDeck(2, g.getCardFromPosInActionTable(3));
        assertEquals("niet de juiste kaart gevonden", "action",d.getCardOnPos(2).getType());
    }
    ...
    public void removeFromDeck() throws Exception {
        d.removeFromDeck(4);
        assertEquals("Kaart niet verwijderd", 4,d.getSize());
    }
